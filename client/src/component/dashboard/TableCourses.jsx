...
export default function TableCourses({ rows,edit }) {
  ...
  const setIsPublish = async(isPublish,courseId) => {
    try {
      const response = await axios.put(`http://localhost:5000/api/change-publish/${courseId}`, { isPublish });
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* {edit && <TableCell align="left">{row.creator.username}</TableCell>} */}
                    <TableCell align="left">{edit ? 'you' : row.creator.username}</TableCell>
